...
import { ConfirmPopupComponent } from './features/home/orders/confirm-popup/confirm-popup.component';
import { LogoutTimerComponent } from './notifications/logout-timer/logout-timer.component';
...
@NgModule({
  declarations: [AppComponent, ConfirmPopupComponent, LogoutTimerComponent],
  imports: [
    CommonModule,
    BrowserModule,
    TabulatorModule,
